...
It provides the client with an admin page to add/edit site content, vehicle inventory, upload images and videos. View general enquiries generated by users and saved to db, add/edit news posts with images and videos. Guest login: user = guest, password = guestpassword
